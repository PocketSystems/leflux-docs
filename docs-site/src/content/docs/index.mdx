---
title: LeFlux · Your visitors ask, LeFlux does
...
<CardGrid>
  ...
  <Card title="Three layouts" icon="setting">
    Floating bubble, bottom-bar pill, dockable side panel — set the default per-site, or let visitors switch from the chat header (lock it if you'd rather not). Always floating on mobile. Live theme follows your brand color.
  </Card>
</CardGrid>
...
<CardGrid>
  ...
  <LinkCard
    title="Release notes"
    href="/docs/changelog/"
    description="What's new in LeFlux. Every shipped change, newest first."
  />
</CardGrid>
